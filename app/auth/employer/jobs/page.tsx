  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-8 bg-white min-h-screen">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          <Card key={i} 
            ...
            onClick={() => stat.label === "Interviews Scheduled" && router.push("/auth/employer/jobs/interviews")}
          >
      ...
      <div className="flex justify-center ">
        <Button onClick={()=> router.push("/auth/employer/job-post")} className="bg-[#3FAE2A] hover:bg-green-700 px-50 py-6 rounded-xl text-lg gap-2">
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 mt-auto">
        <Button 
          onClick={() => router.push(`/auth/employer/jobs/details`)} 
