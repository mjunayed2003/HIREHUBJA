      ...
      <div className="pl-2">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-6">
          ...
          <div className="flex items-center gap-6 mt-2 lg:mt-0">
            ...
            <Button onClick={()=>router.push('/auth/employer/jobs/schedule')} className="bg-[#47B649] hover:bg-[#3da13e] text-white px-3 py-2 h-auto rounded-3xl text-base font-semibold shadow-md min-w-[180px]">
              Schedule Interview
            </Button>
            {/* Reject Link */}
