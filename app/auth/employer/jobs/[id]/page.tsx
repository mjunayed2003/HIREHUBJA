    ...
    <div className="max-w-6xl mx-auto p-8 space-y-10">
      <div className="flex justify-between items-start">
        ...
        <div className="flex gap-4">
          <Button onClick={() => router.push('/auth/employer/jobs/schedule')} className="bg-[#3FAE2A] hover:bg-green-700 px-8 py-6 rounded-xl font-bold">Schedule Interview</Button>
