  ...
  return (
    <div className="max-w-2xl mx-auto p-10 space-y-8">
      ...
      <div className="space-y-6">
        ...
        <Button onClick={() => router.push('/auth/company/jobs/interview')} className="w-full bg-[#3FAE2A] hover:bg-green-700 py-7 text-lg rounded-2xl font-bold mt-4 shadow-lg shadow-green-100">
          Confirm Schedule
        </Button>
      </div>
    </div>
