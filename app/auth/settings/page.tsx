...
const settingsItems = [
  { id: 'password', label: 'Change Password', icon: Lock, color: 'bg-green-600', path: '/auth/settings/change-password' },
  { id: 'about', label: 'About Us', icon: Info, color: 'bg-green-500', path: '/auth/settings/about-us' },
  { id: 'terms', label: 'Terms & Conditions', icon: FileText, color: 'bg-green-600', path: '/auth/settings/terms' },
  { id: 'privacy', label: 'Privacy Policy', icon: Shield, color: 'bg-green-600', path: '/auth/settings/privacy' },
